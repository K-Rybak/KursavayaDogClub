...
namespace KursavayaDogClub.Controllers
{
    public class DistrictsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DISTRICT_ID,DISTRICT_NAME")] DISTRICT dISTRICT)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DISTRICT_ID,DISTRICT_NAME")] DISTRICT dISTRICT)
        {
            if (ModelState.IsValid)
            {
